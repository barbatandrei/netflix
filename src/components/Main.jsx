...
const Main = () => {
	...
	const cutText = (nr, num) => {
		if (nr?.length > num) {
			return nr.slice(0, num) + "...";
		} else {
			return nr;
		}
	};
		...
		<>
			<div className="w-full h-[950px] text-white">
				<div className="h-full w-full">
					<div className="absolute w-full h-[950px] bg-gradient-to-r from-black border-b-8 border-[#222]"></div>
					<img
